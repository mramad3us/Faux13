...
const MISSION_TYPES = {
  ...
  DOMESTIC_TERROR: {
    ...
    suspectVars: {
      ...
      role:        ['suspected cell leader', 'cell coordinator', 'operations officer', 'logistics handler'],
      confidence:  ['HIGH', 'HIGH', 'MODERATE', 'MODERATE', 'LOW'],
      decoy_alias: ['SPARROW', 'EAGLE', 'FALCON', 'HAWK', 'RAVEN', 'OWL'],
      decoy_role:  ['associated contact', 'peripheral associate', 'unknown affiliate', 'low-value contact'],
    },
    urgencyRange: [7, 18],
    threatRange: [3, 5],
    invDaysRange: [2, 4],
  ...
  FOREIGN_HVT: {
    ...
    suspectVars: {
      ...
      role:        ['weapons broker', 'terror financier', 'foreign intelligence officer', 'fugitive arms dealer'],
      confidence:  ['HIGH', 'HIGH', 'MODERATE', 'LOW'],
      decoy_alias: ['MIRAGE', 'GHOST', 'SHADOW', 'ECHO', 'VEIL'],
      decoy_role:  ['unrelated individual', 'low-value contact', 'possible decoy identity', 'unverified lead'],
    },
    urgencyRange: [10, 25],
    threatRange: [3, 5],
    invDaysRange: [3, 5],
  ...
  DOMESTIC_HVT: {
    ...
    suspectVars: {
      ...
      role:        ['foreign intelligence officer', 'known saboteur', 'fugitive suspect', 'technology thief'],
      confidence:  ['HIGH', 'MODERATE', 'MODERATE', 'LOW'],
      decoy_alias: ['PEBBLE', 'CANDLE', 'WINDOW', 'BRIDGE', 'HARBOR'],
      decoy_role:  ['low-priority contact', 'peripheral associate', 'unrelated individual', 'possible cutout'],
    },
    urgencyRange: [8, 20],
    threatRange: [3, 5],
    invDaysRange: [2, 4],
  ...
  SURVEILLANCE_TAKEDOWN: {
    ...
    targetSuspectCount: [1, 3],
    suspectVars: {
      alias:       ['WINDMILL', 'DOCKHAND', 'SPARROW', 'CARDINAL', 'INKWELL', 'FOXGLOVE', 'MAPLELEAF', 'KEYSTROKE'],
      role:        ['suspected foreign intelligence asset', 'compromised government contractor', 'hostile-linked recruiter'],
      confidence:  ['HIGH', 'MODERATE', 'MODERATE', 'LOW'],
      decoy_alias: ['COMPASS', 'LANTERN', 'RUDDER', 'THISTLE', 'BRACKET'],
      decoy_role:  ['peripheral contact', 'unrelated associate', 'unwitting facilitator', 'low-priority flag'],
    },
    urgencyRange: [28, 45],
    threatRange: [2, 4],
    phases: [
  ...
  MOLE_HUNT: {
    ...
    suspectVars: {
      alias:       ['TRITON', 'MARINER', 'HERALD', 'PILGRIM', 'COBBLER', 'WARDEN', 'FLETCHER', 'MASON'],
      role:        ['primary suspect — insider threat', 'senior analyst under surveillance', 'case officer with broad access'],
      confidence:  ['HIGH', 'MODERATE', 'MODERATE', 'LOW'],
      decoy_alias: ['COURIER', 'SENDER', 'RELAY', 'PROXY', 'MIRROR'],
      decoy_role:  ['incidental access match', 'peripheral access holder', 'administratively flagged', 'low-priority candidate'],
    },
    urgencyRange: [35, 55],
    threatRange: [3, 5],
    phases: [
